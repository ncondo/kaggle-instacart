...
if __name__ == '__main__':
    ...
    print(arboretum.head())
    print('-------------------------------------------------------------')
    print(lgbm.shape)
    print(lgbm.head())
    print('-------------------------------------------------------------')

    data['prediction'] = arboretum['prediction']*0.665 + lgbm['prediction']*0.335
    print(data.shape)
    print(data.head())
    ...
    df_order[['order_id', 'products']].to_csv('../submissions/sub_ensemble_wa6634.csv', index=False)
